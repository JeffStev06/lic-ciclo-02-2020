function inicializar(){
    ...
    do {
        orderType = prompt("Qué tipo de ordenamiento desea? (digite 'ascendente' o 'descendente')","ascendente")
        if (!(orderType == "ascendente" || orderType == "descendente")) {
            alert("Digite 'ascendente' o 'descendente' ")
        }
    } while (!(orderType == "ascendente" || orderType == "descendente"))
